...
import com.hz6826.clockin.sql_old.model.sqlite.DailyClockInRecord;
import com.hz6826.clockin.sql_old.model.sqlite.Mail;
import com.hz6826.clockin.sql_old.model.sqlite.Reward;
import com.hz6826.clockin.sql_old.model.sqlite.User;
    ...
    public User getOrCreateUser(String uuid, String playerName) {
        ...
        if (user == null) {
            ...
            try (PreparedStatement preparedStatement = getConn().prepareStatement("INSERT INTO users (uuid, player_name, balance, raffle_ticket, makeup_card) VALUES (?,?, 0, 0, 0)")) {
                ...
                ClockIn.LOGGER.error("Failed to create user: " + e.getMessage(), e);
            }
