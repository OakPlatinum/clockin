package com.hz6826.clockin.sql_old;
...
import com.hz6826.clockin.sql_old.model.mysql.DailyClockInRecord;
import com.hz6826.clockin.sql_old.model.mysql.Mail;
import com.hz6826.clockin.sql_old.model.mysql.Reward;
import com.hz6826.clockin.sql_old.model.mysql.User;
...
public class MySQLDatabaseManager implements DatabaseManager{
    ...
    public MySQLDatabaseManager() {
        ...
        try {
            ...
            ClockIn.LOGGER.error("Couldn't connect to SQL server! {}", e.getMessage());
        }
    }
